...
/tmp/squashfs-root/usr/bin/appimagetool $HOME/squashfs-root -u "gh-releases-zsync|detzahard|pineapple-src|continuous|yuzu-x86_64.AppImage.zsync"
#	mv yuzu-x86_64.AppImage old.AppImage
#VERSION=pineapple /tmp/mkappimage.AppImage --appimage-extract-and-run $HOME/squashfs-root -u "gh-releases-zsync|detzahard|pineapple-src|continuous|yuzu-x86_64.AppImage.zsync"
